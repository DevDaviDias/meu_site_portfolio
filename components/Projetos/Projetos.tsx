...
const PROJETOS_DATA: Projeto[] = [
  {
    title: "PinkLife",
    description: "PinkLife é uma aplicação web estilo SaaS de organização pessoal voltada ao público feminino, que centraliza hábitos, estudos, treinos, finanças e rotina diária em um único painel interativo.",
    imagem: "/pinklife.png",
  ...
  },
  {
    ...
    description: "Aplicação web moderna para cadastro de clientes, controle de serviços e peças utilizadas. Desenvolvida com React, Node.js, PostgreSQL e Stripe.",
    imagem: "/projeto1.png",
  ...
  },
  {
    ...
    description: "Plataforma de ensino tecnológico completa para organizar o aprendizado de TI. Possui sistema de login, navegação SPA, grid de aulas e layout de aulas com vídeo.",
    imagem: "/emtidev.png",
  ...
  },
  {
    ...
    description: "Dashboard interativo que exibe preços em tempo real e gráficos dos últimos 7 dias via API CoinGecko.",
    imagem: "/cripto.jpg",
  ...
  },
  {
    ...
    description: "API REST desenvolvida com Express que fornece dados dos personagens do anime Classroom of the Elite.",
    imagem: "/Apisoft.png",
  ...
  return (
    <section id="projetos" className="w-full py-10 lg:ml-[288px] lg:w-[calc(100%-288px)] transition-all duration-300">
      ...
      <div className="w-full px-4 md:pl-20 md:pr-10 max-w-[1440px]">
        ...
        {/* --- SEÇÃO OUTROS PROJETOS (Alinhada com o grid acima) --- */}
        <div className="space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {otherProjects.map((project, index) => (
              <SimpleCard key={project.title} project={project} index={index} />
            ))}
          </div>
        </div>
...
function FeaturedCard({ project, index }: { project: Projeto; index: number }) {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
    >
      <Card className="flex flex-col h-full border-none shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden bg-white dark:bg-slate-900/50 backdrop-blur-md group">
...
function SimpleCard({ project, index }: { project: Projeto; index: number }) {
  return (
    <motion.div
      initial={{ opacity: 0, y: 20 }}
      whileInView={{ opacity: 1, y: 0 }}
